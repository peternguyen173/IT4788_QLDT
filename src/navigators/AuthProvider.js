...
export const AuthProvider = ({ children }) => {
  ...
  return (
      <AuthContext.Provider value={{ setIsLoggedIn, isLoggedIn, userData, login, logout, loading, setUserData,markInboxAsRead, unreadCount, fetchUnreadCount,fcmToken,setFcmToken,unreadNotifications,setUnreadNotifications,get_unread_notifications }}>
      {children}
